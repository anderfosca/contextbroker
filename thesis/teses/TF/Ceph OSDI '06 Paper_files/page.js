...
<link type="text/css" rel="stylesheet" href="https://www.usenix.org/sites/default/files/css/css_YZMBEd37jA3ZzMQR649hsDZRrYeN1RfmzWccYPc07tE.css" media="all" />
...
<!--[if lte IE 8]>
<link type="text/css" rel="stylesheet" href="https://www.usenix.org/sites/all/themes/waves/css/ie.css?nq0783" media="all" />
<![endif]-->
...
<!--     <link href='http://fonts.googleapis.com/css?family=Noto+Sans' rel='stylesheet' type='text/css'> -->
    ...
    <script type="text/javascript" src="https://www.usenix.org/sites/default/files/js/js_xAPl0qIk9eowy_iS9tNkCWXLUVoat94SQT48UBCFkyQ.js"></script>
<script type="text/javascript" src="https://www.usenix.org/sites/default/files/js/js_JHlQgchJLv3IvDdNp-rwrmw7VOgyF3I0mVjKgL8WeuU.js"></script>
<script type="text/javascript" src="https://www.usenix.org/sites/default/files/js/js_yrVLj-LkZ3ZnoZN_yPyjkj41srvUHHkzUMRbe12M3lw.js"></script>
<script type="text/javascript">
<!--//--><![CDATA[//><!--
var _gaq = _gaq || [];_gaq.push(["_setAccount", "UA-3633391-4"]);_gaq.push(["_gat._anonymizeIp"]);_gaq.push(["_trackPageview", "/404.html?page=" + document.location.pathname + document.location.search + "&from=" + document.referrer]);(function() {var ga = document.createElement("script");ga.type = "text/javascript";ga.async = true;ga.src = "https://www.usenix.org/sites/default/files/googleanalytics/ga.js?nq0783";var s = document.getElementsByTagName("script")[0];s.parentNode.insertBefore(ga, s);})();
//--><!]]>
</script>
...
<div id='top-outer'><div id='top' class='limiter'>
  <div id='top-inner'>
    ...
    <div class="top-right">
      <div id='header-login'>
        <span class="header-login-first"><a href="/user?destination=legacy/event/osdi06/tech/full_papers/weil/weil_html/page.js">Sign In</a></span><a href="/user/register?destination=legacy/event/osdi06/tech/full_papers/weil/weil_html/page.js">Create Account</a>      </div>
      <div id="search-bar">
        <form action="/legacy/event/osdi06/tech/full_papers/weil/weil_html/page.js" method="post" id="search-block-form" accept-charset="UTF-8"><div><div class="container-inline">
      <h2 class="element-invisible">Search form</h2>
    <div class="form-item form-type-textfield form-item-search-block-form">
  <input title="Enter the terms you wish to search for." type="text" id="edit-search-block-form--2" name="search_block_form" value="" size="15" maxlength="128" class="form-text" />
</div>
<div class="form-actions form-wrapper" id="edit-actions"><input type="submit" id="edit-submit" name="op" value="Go" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-jxllGi2uYTTORtL_2tPPyvFRT4mQ9nRAK9wHjxzOSu0" />
...
<p style="text-align: center;"><img src="/sites/default/files/usenix40_logo_133x100.png" alt="" width="133" height="100" /><br />
© USENIX 2015</p>
</div> </div>
